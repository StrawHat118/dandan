...
#输入注册账号--BD账号
     input text          css=#MobileNum          15921215093
    #点击下一步
    ...
    #点击福利券管理
    click element       css=#react-placeholder > div > div > div > div.screen-content.mybusiness > div.mybusiness-menu > dl:nth-child(3) > dd > img
    #点击 添加福利券
    click element       css=#react-placeholder > div > div > div:nth-child(2) > div.screen-content.coupon.tabs.-notborder.-fixed > div.fixed-bottom > a
    #点击 选择商户
    click element       css=#react-placeholder > div > div > div:nth-child(3) > div.screen-content.coupon-add > div.addcoupon-form > div.cell.-right-line.coupon-wrap > div:nth-child(1) > div.-value
    #点击 确定
    ...
    ...                 1024
    #输入发行数量
    input text          css=#react-placeholder > div > div > div:nth-child(3) > div.screen-content.coupon-add > div.addcoupon-form > div.cell.-right-line.coupon-wrap > div:nth-child(5) > div.-value > input[type="text"]
    ...                 512
    #选择时间
    ...
    #选择时间
    click element       css=#react-placeholder > div > div > div:nth-child(3) > div:nth-child(3) > div > div > div.picker-container > div > div:nth-child(3) > div > div:nth-child(14)
    #点击确定
    click element       css=#react-placeholder > div > div > div:nth-child(3) > div:nth-child(3) > div > div > div.picker-header > a.sure
    #选择平台展示期
    ...
    click element       css=#react-placeholder > div > div > div:nth-child(3) > div:nth-child(3) > div > div > div.picker-header > a.sure
    #点击适用门店
    click element       css=#react-placeholder > div > div > div:nth-child(3) > div.screen-content.coupon-add > div.addcoupon-form > div.cell.-right-line.coupon-wrap > div:nth-child(12) > div.-value
    #选择门店
    ...
    #输入使用规则
    input text          css=#react-placeholder > div > div > div:nth-child(3) > div.screen-content.coupon-add > div.addcoupon-form > div.cell.-right-line.coupon-wrap > div:nth-child(13) > div.-value > input[type="text"]
    ...                 满2048元减1024元
    #休息一下
