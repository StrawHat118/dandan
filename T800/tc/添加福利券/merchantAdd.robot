...
#输入注册账号--商户账号
     input text          css=#MobileNum          18367150062
    #点击下一步
...
#    click element       css=#react-placeholder > div > div:nth-child(2) > div > div > a.accredit_btn
    #点击福利券管理
    click element       css=#react-placeholder > div > div > div > div.screen-content.my-merchant > div.-merchant-menu > dl:nth-child(1) > dd
    #点击添加福利券
